...
public class S {
	...
	public S(int x, int y) {
		...
		type = "S";
		rotated = 1;
		iShape1 = new BasicCube(this.x, this.y+25, type);		// 	34
		iShape2 = new BasicCube(this.x+25, this.y+25, type);	// 12
	...
	public void rotateClockwise(){
		if(rotated==1){
			iShape1.translate(0, -25);	//from   34  to 1
			iShape2.translate(-25, 0);	//      12      23
			iShape3.translate(0, 25);	//               4
			iShape4.translate(-25, 25+25);
			rotated = 2;
		}
		else{ //if(rotated==2 || rotated==4)
			iShape1.translate(0, 25);
			iShape2.translate(25, 0);
			iShape3.translate(0, -25);
			iShape4.translate(25, -25-25);
			rotated = 1;
		}
	}
