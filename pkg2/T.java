...
public class T {
	...
	public T(int x, int y) {
		...
		iShape4 = new BasicCube(this.x+25, this.y, type);
	}
	...
	public void rotateClockwise(){
		if(rotated==1){
			...
			iShape2.translate(-25, 0);		//       123      24
			iShape3.translate(-25-25, 25);	//				  3
			iShape4.translate(0, 25);		
			rotated = 2;
		}
		else if(rotated==2){
			//iShape1.translate(0, 0);			//from 1    to  123
			iShape2.translate(25, -25);			//     24        4
			iShape3.translate(25+25, -25-25);	//     3
			//iShape4.translate(0, 0);
			rotated = 3;
		}
		else if(rotated==3){
			iShape1.translate(25, 25);		//from  123  to  3
			iShape2.translate(0, 25+25);	//       4      41
			iShape3.translate(-25, 0);		//               2
